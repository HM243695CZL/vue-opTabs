...
<script>
import {isFunction, isString, isObject, store, constants} from './utils'
...
export default {
    ...
    methods: {
        ...
        create (tab) {
          console.log("(" + moment(new Date()).format("YYYY-MM-DD HH:mm:ss") + ")  " + tab.meta.componentName + "加载完成");
        ...
        _saveTabs () {
            ...
            store.save(constants.STORE_KEY, toSave)
        }
    }
}
</script>
